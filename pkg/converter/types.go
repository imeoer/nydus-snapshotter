...
type PackOption struct {
	...
	// Backend uploads blobs generated by nydus-image builder to a backend storage.
	Backend Backend
	// WithTarToRafs enables converting OCI tar blob stream into nydus blob
	// directly, without decompressing it to a local directory first, it can
	// speed up the pack operation.
	WithTarToRafs bool
