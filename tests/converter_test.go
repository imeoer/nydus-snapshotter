...
func TestPack(t *testing.T) {
	t.Log("============ Test nydusd 2.2 + nydus-image 2.2")
	os.Setenv("NYDUS_NYDUSD", "/home/imeoer/nydusd-new")
	os.Setenv("NYDUS_BUILDER", "/home/imeoer/nydus-image-new")
	testPack(t, "5")
	testPack(t, "6")

	t.Log("============ Test nydusd 2.1 + nydus-image 2.1")
	os.Setenv("NYDUS_NYDUSD", "/home/imeoer/nydusd")
	os.Setenv("NYDUS_BUILDER", "/home/imeoer/nydus-image")
	testPack(t, "5")
	testPack(t, "6")

	t.Log("============ Test nydusd 2.2 + nydus-image 2.1")
	os.Setenv("NYDUS_NYDUSD", "/home/imeoer/nydusd-new")
	os.Setenv("NYDUS_BUILDER", "/home/imeoer/nydus-image")
	testPack(t, "5")
	testPack(t, "6")

	t.Log("============ Test nydusd 2.1 + nydus-image 2.2")
	os.Setenv("NYDUS_NYDUSD", "/home/imeoer/nydusd")
	os.Setenv("NYDUS_BUILDER", "/home/imeoer/nydus-image-new")
	testPack(t, "5")
	testPack(t, "6")
